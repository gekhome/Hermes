...
namespace Hermes.Controllers.UserControllers
{
    ...
    public class USER_ADMINSController : Controller
    {
        ...
        public USER_ADMINSController(HermesDBEntities entities, IUserAdminService userAdminService)
        {
            db = entities;
        ...
        public ActionResult Login2([Bind(Include = "USERNAME,PASSWORD")]  UserAdminViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                return RedirectToAction("UserParentsList", "USER_PARENTS");
            }
            ModelState.AddModelError("", "Το όνομα χρήστη ή/και ο κωδ.πρόσβασης δεν είναι σωστά");
            return View(model);
        }
        ...
        #region ADMIN GRID CRUD Functions
